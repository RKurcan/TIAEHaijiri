...
{
    public class DailyEmployeeAttendanceReportApiController : ApiController
    {
        [HttpPost]
        public KendoGridResult<List<AttendanceReportDetailViewModel>> GenerateReport(KendoReportViewModel vm)
        {
            ...
            return new KendoGridResult<List<AttendanceReportDetailViewModel>>()
            {
                Data = reportData,
