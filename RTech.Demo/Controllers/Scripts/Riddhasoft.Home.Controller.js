    ...
    self.KendoGridOptions = function (title, type, target) {
        ...
        return {
            ...
            columns: [
                ...
                { field: 'PlannedTimeIn12Format', title: language == "ne" ? "तोकीएको आउने समय " : "Planned In", filterable: false, sortable: false, template: "#=SuitableNumber(PlannedTimeIn12Format)#" },
                ...
                { field: 'PlannedTimeOut12Format', title: language == "ne" ? "तोकीएको जाने  समय " : "Planned Out", filterable: false, sortable: false, template: "#=SuitableNumber(PlannedTimeOut12Format)#" },
                ...
                { field: 'ActualTimeIn12Format', title: language == "ne" ? "कर्मचारी आको समय " : "Actual In", filterable: false, sortable: false, template: "#=SuitableNumber(ActualTimeIn12Format)#" },
                ...
                { field: 'ActualTimeOut12Format', title: language == "ne" ? "कर्मचारी गको समय " : "Actual Out", filterable: false, sortable: false, template: "#=SuitableNumber(ActualTimeOut12Format)#" },
            ],
